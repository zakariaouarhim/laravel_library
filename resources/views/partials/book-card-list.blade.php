<div class="book-item list-style d-flex mb-3 p-3 border rounded">
    <img src="{{ asset($book->image ?? 'images/book-placeholder.png') }}" alt="{{ $book->title }}" style="width: 120px;" class="me-3">
    <div>
        <h5><a href="{{ route('moredetail.page', ['id' => $book->id]) }}">{{ $book->title }}</a></h5>
